...
public:
    ...
    AcyclicNodeHandle(const AcyclicNodeHandle& other) noexcept {
        if (other.hasHandle()) {
            EntropyEngine::Core::HandleAccess::set(*this, const_cast<void*>(other.handleOwner()), other.handleIndex(),
    ...
    AcyclicNodeHandle& operator=(const AcyclicNodeHandle& other) noexcept {
        if (this != &other) {
            if (other.hasHandle()) {
                EntropyEngine::Core::HandleAccess::set(*this, const_cast<void*>(other.handleOwner()),
                                                       other.handleIndex(), other.handleGeneration());
            } else {
